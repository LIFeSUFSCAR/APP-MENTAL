        ...
        body: Scrollbar(
          ...
          child: Html(
              data: "<p><b><u>Título do projeto:</u> Desenvolvimento participativo do " +
                  ...
                  "Departamento de Medicina da UFSCar<br />" +
                  "Departamento de Computação da UFSCar<br />" +
                  "Programa de Pós-Graduação em Gestão da Clínica - PPGGC/UFSCar<br />" +
                  "Programa de Pós-Graduação em Ciência da Computação - PPGCC/UFSCar</p>" +
                  "<p><b><u>Apoio:</u></b><br/>" +
